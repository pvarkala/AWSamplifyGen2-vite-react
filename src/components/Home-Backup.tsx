...
const Home: React.FC = () => {
  ...
  const stats = [
    ...
    { value: "5M+", label: "Tasks Completed", icon: CheckCircle },
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:ml-10 md:flex md:space-x-1">
                ...
                <a href="#integrations" className="text-gray-700 hover:text-blue-600 px-4 py-2 text-sm font-medium transition-all hover:bg-blue-50 rounded-lg">
                  Integrations
                </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-lg border-t border-gray-200/50">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#features" className="text-gray-700 hover:text-blue-600 block px-4 py-3 text-base font-medium hover:bg-blue-50 rounded-lg">
                Features
              </a>
              <a href="#testimonials" className="text-gray-700 hover:text-blue-600 block px-4 py-3 text-base font-medium hover:bg-blue-50 rounded-lg">
                Testimonials
              </a>
              <a href="#integrations" className="text-gray-700 hover:text-blue-600 block px-4 py-3 text-base font-medium hover:bg-blue-50 rounded-lg">
                Integrations
              </a>
              <a href="#pricing" className="text-gray-700 hover:text-blue-600 block px-4 py-3 text-base font-medium hover:bg-blue-50 rounded-lg">
                Pricing
              </a>
              <Link 
                to="/signin" 
                className="text-gray-700 hover:text-blue-600 block px-4 py-3 text-base font-medium hover:bg-blue-50 rounded-lg"
              >
                Sign In
              </Link>
              <Link 
                to="/signup" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white block px-4 py-3 text-base font-medium rounded-lg"
              >
                Get Started Free
              </Link>
            </div>
...
export default Home;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className={`group relative bg-gradient-to-br ${feature.bgGradient} p-8 rounded-2xl border ${feature.borderColor} hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer ${activeFeature === index ? 'ring-2 ring-blue-500 ring-offset-2' : ''}`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600">
                ...
                See how teams collaborate, track progress, and achieve their goals.
              </p>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8">
                <div className="space-y-4">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-gray-900">Project Dashboard</h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm font-medium text-gray-700">Design Review</span>
                      </div>
      ...
      <section id="integrations" className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-full mb-4">
              <Code2 className="w-4 h-4 text-indigo-600 mr-2" />
              <span className="text-sm font-medium text-indigo-800">Seamless Integration</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Works With Your
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Connect TodoPro with the tools your team already uses. Sync data, automate workflows, and boost productivity.
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {integrations.map((integration, index) => (
              <div key={index} className="group bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 cursor-pointer">
                <div className={`w-12 h-12 ${integration.color} rounded-xl flex items-center justify-center mb-4 transform group-hover:scale-110 transition-transform`}>
                  {integration.icon}
                </div>
                <p className="text-sm font-medium text-gray-900 text-center">{integration.name}</p>
              </div>
            ))}
          </div>
        </div>
